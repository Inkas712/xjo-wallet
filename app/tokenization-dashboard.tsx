...
export default function TokenizationDashboardScreen() {
...
const styles = StyleSheet.create({
  ...
  pnlBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, marginTop: 4 },
  pnlText: { fontSize: 13, fontWeight: '600' as const, marginLeft: 4 },
  solanaBadge: { flexDirection: 'row', alignItems: 'center', marginTop: 16, backgroundColor: 'rgba(153,69,255,0.12)', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, alignSelf: 'flex-start' },
